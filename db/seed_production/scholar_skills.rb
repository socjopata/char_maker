...
skill.skill_requirements.create(:check_applies_to => "skill", :name => "Runy Proste" )
skill.skill_requirements.create(:check_applies_to => "other", :name => "Posiadanie Mocy" ) #TODO implement it
...
skill = Skill.create(:profession_type => "scholar",
                     :name => "Medycyna, Chirurgia i Anatomia",
...
skill.skill_requirements.create(:check_applies_to => "skill", :name => "Posiadanie Mocy" )
s_choice = skill.stats_choices.create
...
skill.skill_requirements.create(:check_applies_to => "other", :name => "Posiadanie Mocy" )
