...
[
 ...
 spell = Spell.create(:name => hash[:name], :description => hash[:description],  :profession_id => profession.id, :index => i+1)
 spell.spell_requirements.create(check_applies_to: "experience", value: "1")
end
...
[
  ...
  spell = Spell.create(:name => hash[:name], :description => hash[:description],  :profession_id => profession.id, :index => i+1)
  spell.spell_requirements.create(check_applies_to: "experience", value: "2")
end
...
#TODO Implement more levels if needed. Atm we basically need only lvl 1.
