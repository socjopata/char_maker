...
_profession.countries << [Country.find_all_by_name(["Alantar", "Archipelag Południowy", "Góry Niczyje i Księżycowe",  "Nimer", "Pelmir", "Wielkie Stepy", "Wyspy Północy", "Ziemie Sirtol", "Złote Królestwa"])]
...
_profession.countries << Country.find_all_by_name(["Alantar", "Archipelag Południowy", "Góry Niczyje i Księżycowe", "Wielkie Stepy", "Wyspy Północy", "Ziemie Sirtol", "Złote Królestwa"])
